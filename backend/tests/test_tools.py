...
if __name__ == "__main__":
    ...
    test_plan_days_fits_evenly()
    test_plan_days_uses_pace_default()
    test_plan_days_reports_when_it_does_not_fit()
    test_plan_days_invalid_dates()
    test_plan_days_malformed_date()
    print("\nAll tests passed.")